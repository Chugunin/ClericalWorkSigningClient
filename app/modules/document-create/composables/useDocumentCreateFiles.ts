...
import type {DocumentFormFile} from "../model/document-create-form.model";
import type {FileEntry} from "#shared/contracts/files/file-entry.contract";

export interface UseDocumentCreateFilesOptions {
    saveFile?: (file: File) => Promise<FileEntry>
}

export interface UseDocumentCreateFilesReturn {
...
export function useDocumentCreateFiles(
    files: Ref<File[] | undefined>,
    options: UseDocumentCreateFilesOptions = {},
): UseDocumentCreateFilesReturn {
